      ...
      <aside className="sidenav">
         <div className="sidenav-content">
            <div className='sidenav-group1'>
               ...
               <Link to="/Gerente_hist-consultas">
               <div className='sidenav-buttons'>
