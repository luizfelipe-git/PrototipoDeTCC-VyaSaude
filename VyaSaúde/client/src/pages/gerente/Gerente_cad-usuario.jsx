               ...
               <Form id="form-registro" onSubmit={handleRegister}>
                  <div>
                     ...
                     <div className="form-fields">
                        ...
                        <Form.Control name="cpf" value={formDados.cpf} length={4} minLength={3} onChange={(e) => handleFormChange(e)} type='number' placeholder='CPF'/>
...
export default Gerente_cadUsuario;